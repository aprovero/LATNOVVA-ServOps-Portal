...
export const mockProjects: Project[] = [
    ...
    // Power Electronics
    { id: 'PROJ-PE1', clientId: 'CUST_POWER_ELEC', name: 'PE Inverter Array Beta', type: 'Complete', status: 'Active', progress: 95, scopes: [] },
    { id: 'PROJ-PE2', clientId: 'CUST_POWER_ELEC', name: 'PE Grid Tie Expansion', type: 'Simple', status: 'Completed', progress: 100, scopes: [] },
    { id: 'PROJ-PE3', clientId: 'CUST_POWER_ELEC', name: 'PE Rural Farm Install', type: 'Complete', status: 'Active', progress: 60, scopes: [] },

    // Ferrovial
    { id: 'PROJ-F1', clientId: 'CUST_FERROVIAL', name: 'Ferrovial Highway Solar', type: 'Complete', status: 'Active', progress: 30, scopes: [] },
    { id: 'PROJ-F2', clientId: 'CUST_FERROVIAL', name: 'Interstate Charging Hub', type: 'Simple', status: 'Active', progress: 10, scopes: [] },
    { id: 'PROJ-F3', clientId: 'CUST_FERROVIAL', name: 'Border Station Microgrid', type: 'Complete', status: 'On Hold', progress: 0, scopes: [] },
    { id: 'PROJ-F4', clientId: 'CUST_FERROVIAL', name: 'Ferrovial Valley Wind', type: 'Complete', status: 'Completed', progress: 100, scopes: [] },

    // CEN Solutions
    { id: 'PROJ-C1', clientId: 'CUST_CEN', name: 'CEN Smart Control Room', type: 'Complete', status: 'Completed', progress: 100, scopes: [] },
    { id: 'PROJ-C2', clientId: 'CUST_CEN', name: 'CEN Substation Upgrade', type: 'Simple', status: 'Active', progress: 75, scopes: [] },
    { id: 'PROJ-C3', clientId: 'CUST_CEN', name: 'Transmission Automation', type: 'Complete', status: 'Active', progress: 50, scopes: [] },
    { id: 'PROJ-C4', clientId: 'CUST_CEN', name: 'SCADA Implementation', type: 'Complete', status: 'Active', progress: 25, scopes: [] },
];
