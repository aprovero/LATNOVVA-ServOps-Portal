            ...
            <section className="bg-brand-teal py-28 px-8">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {[
                            { flag: '🇲🇽', country: 'Mexico — Mérida', address: 'Calle 56 #500, Office 1 Building 6, Itzimina, Mérida, Yuc.' },
                            { flag: '🇲🇽', country: 'Mexico — CDMX', address: 'Río Nilo 80, Office 301, Cuauhtémoc, Mexico City' },
                            { flag: '🇺🇸', country: 'United States', address: '1801 NE 123rd Street Suite 336, Miami, Florida' },
                            { flag: '🇨🇴', country: 'Colombia', address: 'Calle 93 #15-27, Office 702. Bogotá' },
                            { flag: '🇩🇴', country: 'Dominican Republic', address: 'C/ Ensanche 1B, Punta Cana' },
                            { flag: '🇨🇱', country: 'Chile', address: 'Apoquindo 5950, Floor 21 Office 21-116, Las Condes, Santiago' },
                        ].map((office, i) => (
                            <Reveal key={office.country} delay={100 + i * 50}>
                                <div className="bg-white/12 backdrop-blur border border-white/20 rounded-2xl p-5 hover:bg-white/20 transition-all">
                                    <div className="flex items-center gap-2 mb-2">
